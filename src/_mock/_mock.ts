...
export const _postTitles = (index: number) =>
  ['Отгрузка в Коледино', 'Отгрузка на склад в Хоругвино', 'Отгрузка на склад в Москву'][index];

export const _description = (index: number) =>
  ['была произведена успешно', 'была отменена', 'была произведена успешно'][index];
...
export const _productNames = (index: number) =>
  ['Курьерский пакет 400x500мм', 'Коробка 60x40см', 'Пупырчатая упаковка', 'Коробка 30x30см'][
    index
  ];
